...
public:
  ...
  double Ranexp(double lambda);
  double Rancauchy(double gamma, double mu);
  double Ranretta();
  pair<double, double> BlockAV(double* array, int dimarray); 
  void BlockAV_file(double* array, int dimarray, std:: ofstream& file);
  void BlockAV_file_vector(vector<double> array, int dimarray, std:: ofstream& file);
};
