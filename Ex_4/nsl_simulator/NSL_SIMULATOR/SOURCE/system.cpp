  ...
  if (input.is_open()){
    while ( !input.eof() ){
      ...
      if( property == "POTENTIAL_ENERGY" ){
        ofstream coutp("../OUTPUT/potential_energy_nada.dat");
        ...
        ofstream coutk("../OUTPUT/kinetic_energy_liquid.dat");
        ...
        ofstream coutt("../OUTPUT/total_energy_nada.dat");
        ...
        ofstream coutte("../OUTPUT/temperature_nada.dat");
        ...
        ofstream coutpr("../OUTPUT/pressure_nada.dat");
...
void System :: averages(int blk){
  ...
  // POTENTIAL ENERGY //////////////////////////////////////////////////////////
  if (_measure_penergy){
    coutf.open("../OUTPUT/potential_energy_nada.dat",ios::app);
  ...
  // KINETIC ENERGY ////////////////////////////////////////////////////////////
  if (_measure_kenergy){
    coutf.open("../OUTPUT/kinetic_energy_liquid.dat",ios::app);
  ...
  // TOTAL ENERGY //////////////////////////////////////////////////////////////
  if (_measure_tenergy){
    coutf.open("../OUTPUT/total_energy_nada.dat",ios::app);
  ...
  // TEMPERATURE ///////////////////////////////////////////////////////////////
  if (_measure_temp){
    coutf.open("../OUTPUT/temperature_nada.dat",ios::app);
  ...
  if (_measure_pressure){
    coutf.open("../OUTPUT/pressure_nada.dat",ios::app);
